                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header fs-1">Data Transaksi Pengembalian</div>
                                    <div class="btn-cta d-flex justify-content-end me-4">
                                        <a href="add-transaksi.php" class="btn btn-info">Add Transaksi</a>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                $no = 1;
                                                while ($rowDataTransaksi = mysqli_fetch_assoc($dataTransaksi)):
                                                ?>
                                                    <tr>
                                                        <td><?php echo  $no++; ?></td>
                                                        ...
                                                        <td><?php
                                                            ...
                                                            ?></td>
                                                        <td>
                                                            <a href="../views/add-transaksi.php?detail=<?php echo $rowDataTransaksi['id'] ?>" class="btn btn-primary btn-sm"><span class="tf-icon bx bx-show"></span></a>
                                                            ...
                                                            <a href="../controller/action_transaksi.php?delete=<?php echo $rowDataTransaksi['id'] ?>" class="btn btn-danger btn-sm"><span class="tf-icon bx bx-trash" onclick="return confirm('Are you sure want to delete this item?')">Delete</span></a>
                                                        </td>
                                                    </tr>
                                                <?php endwhile ?>
                                            </tbody>
