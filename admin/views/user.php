                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="../views/add-user.php?edit=<?php echo $rowDataUser['id'] ?>" class="btn btn-warning btn-sm"><span class="tf-icon bx bx-pencil me-2">Edit</span></a>
                                                            <a href="../controller/action_users.php?delete=<?php echo $rowDataUser['id'] ?>" class="btn btn-danger btn-sm"><span class="tf-icon bx bx-trash me-2" onclick="return confirm('Are you sure want to delete this item?')">Delete</span></a>
                                                        </td>
                                                    </tr>
                                                <?php endwhile ?>
                                            </tbody>
