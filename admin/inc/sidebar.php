<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <a href="index.php" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">LaundryAWS</span>
        </a>
        ...
        <?php if ($_SESSION['id_level'] == 1): ?>
            <li class="menu-item">
                ...
                <ul class="menu-sub">
                    ...
                    <li class="menu-item">
                        <a href="../views/customer.php" class="menu-link">
                            <div data-i18n="Account">Customer</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="../views/service.php" class="menu-link">
                ...
                <?php if ($_SESSION['id_level'] == 1 or $_SESSION['id_level'] == 2): ?>
                    <li class="menu-item">
                        <a href="../views/transaksi.php" class="menu-link">
